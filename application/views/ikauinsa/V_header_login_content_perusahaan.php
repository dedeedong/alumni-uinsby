          ...
          <nav class="main_nav_container">
            <div class="main_nav">
              <ul class="main_nav_list">
                ...
                <li class="main_nav_item"><a href="<?php echo base_url();?>perusahaan/index">dasboard</a></li>
                <li class="main_nav_item"><a href="javascript: void(0);" id="search-button">cari alumni</a></li>
                <li class="main_nav_item"><a href="<?php echo base_url();?>perusahaan/daftarperusahaan" class="user_container"><?php echo $this->session->userdata('nama'); ?></a></li>
              </ul>
            </div>
          </nav>
        </div>
        ...
        <div class="menu_inner menu_mm">
          <div class="menu menu_mm">
            <ul class="menu_list menu_mm">
              <li class="menu_item menu_mm"><a href="<?php echo base_url();?>perusahaan/daftarperusahaan"><?php echo $this->session->userdata('nama'); ?></a></li>
              <li class="menu_item menu_mm"><a href="<?php echo base_url();?>">Beranda</a></li>
              <li class="menu_item menu_mm"><a href="<?php echo base_url();?>base/news">Berita</a></li>
              <li class="menu_item menu_mm"><a href="<?php echo base_url();?>perusahaan/index">Dasboard</a></li>
