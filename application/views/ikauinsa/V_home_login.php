  ...
  <div class="hero_slider_container">
    <div class="hero_slider owl-carousel">
      ...
      <div class="hero_slide">
        <div class="hero_slide_background" style="background-image:url(../assets/image/slider_background_login_2.jpg)"></div>
        <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
          <div class="hero_slide_content text-center">
            <h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut"><a href="#login" style="color:white;">Selamat Datang Di <span>IKA UINSA</span></a></h1>
          </div>
        </div>
      </div>
      ...
      <!-- Hero Slide -->
      <div class="hero_slide">
        <div class="hero_slide_background" style="background-image:url(../assets/image/slider_background_login_1.jpg)"></div>
        <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
          <div class="hero_slide_content text-center">
    ...
    <div class="event_items">
      <table class="table_zebra">
        ...
        <tr>
          ...
          <td><a href="<?php echo base_url();?>careeruinsa/lowongan"> LAMAR </a></td>
        </tr>
        <?php endforeach;?>
