            ...
            <div id="content">
                <nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Detail Daftar Lowongan</li>
					</ol>
				</nav>

                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#info">Detail Daftar Lowongan Kota</a></li>
                </ul>
                    ...
                    <div class="tab-content">
                        <div id="info" class="tab-pane fade in active">
                            <table id="tabelinfo" class="table table-bordered table-striped dataTable no-footer" style="width:100%">
                                ...
                                <tbody>
                                            <?php
                                            if(count($getdetailkota)){
                                                $var=1;
                                                foreach($getdetailkota as $row)
                                                {
